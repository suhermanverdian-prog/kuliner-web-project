...
const Card = React.forwardRef(({ className, variant = "default", ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      variant === "premium" && "bg-white dark:bg-zinc-950 border-amber-500/30 dark:border-amber-500/20 text-[var(--text-primary)] shadow-[0_0_40px_rgba(245,158,11,0.08)] dark:shadow-[0_0_50px_rgba(245,158,11,0.12)] hover:shadow-[0_0_50px_rgba(245,158,11,0.18)] hover:border-amber-500/40 dark:hover:border-amber-500/30 transition-all duration-300",
