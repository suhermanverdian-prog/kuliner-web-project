...
const Card = React.forwardRef(({ className, variant = "default", ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      variant === "premium" && "bg-[var(--bg-card)] border-amber-500/30 text-[var(--text-primary)] shadow-[0_0_40px_rgba(245,158,11,0.06)] dark:border-amber-500/30 dark:shadow-none",
